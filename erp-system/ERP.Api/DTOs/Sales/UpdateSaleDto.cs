...
public sealed class UpdateSaleDtoValidator : AbstractValidator<UpdateSaleDto>
{
    ...
    public UpdateSaleDtoValidator(ApplicationDbContext context, UserContext userContext)
    {
        _context = context;
        ...
        RuleForEach(x => x.Items).SetValidator(new UpdateSaleItemDtoValidator(_context, _userContext));
...
public sealed class UpdateSaleItemDtoValidator : AbstractValidator<UpdateSaleItemDto>
{
    ...
    public UpdateSaleItemDtoValidator(ApplicationDbContext context, UserContext userContext)
    {
        _context = context;
        _userContext = userContext;
